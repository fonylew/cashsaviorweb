...
<a class="infoen_open btn btn-round btn-info" style="margin-top: 10px; margin-bottom:20px;" href="#infoen">See more</a>

<!-- infoen -->
<div id="infoen" class="well" style="min-width:44em; padding: 2% 2%; padding-top: 0%;">

    <center>
        <h4 style="width: relative; background-color:#4DD0E1; border-radius: 5px; padding: 5%;">entertain example</h4>
    <br>
    ...
    <br>
    <button onclick="myFunction()" class="infoen_close btn btn-lg btn-round btn-success">Done !!</button>
    </center>
</div>
