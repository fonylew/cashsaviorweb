                ...
                <div class="collapse navbar-collapse">
                    <div class="form-group">
                        <ul class="nav navbar-nav navbar-right" style="padding-right: 20px">
                            ...
                            <li>
                                <a href="#" onclick="checkLoginState();" style=" margin:0px;"><img class="displayed" src="img/facebook-login.png" style="height: 35px; width:relative; margin:5px 0px;" border="0" alt="Log in with Facebook">
                                </a>
                                <div id="status">
                                </div>
                            </li>
